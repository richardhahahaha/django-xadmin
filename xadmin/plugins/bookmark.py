...
class BookmarkPlugin(BaseAdminPlugin):
    ...
    def get_context(self, context):
        ...
        new_context = {
            ...
            'has_add_bookmark_permission': self.admin_view.request.user.has_perm('xadmin.add_bookmark'),
            'has_change_bookmark_permission': self.admin_view.request.user.has_perm('xadmin.change_bookmark')
        }
